...
export default function save(props) {
	const { Heading, description, mediaURL, Heading_top, mediaURL2 } =
		props.attributes;
	return (
		<section id="about-section" {...useBlockProps.save()}>
			<div className="about-section">
				<div className="about-section__inner">
					<div className="row">
						<div className="col-lg-6">
							<div className="about-section__inner_heading__top">
								<RichText.Content tagName="h2" value={Heading_top} />
							</div>
						...
						<div className="col-lg-6">
							<div className="about-section__inner__img">
								<img src={mediaURL2} />
							</div>
						</div>
					</div>
